...
{
    [Serializable]
    public class UserTableColumn : IDataObject, IDataUserTableBasedObject
    {
        ...
        public string ObjectName
        {
            ...
            set
            {
                if (UserTable != null)
                {
                    if (UserTable.RenameUserTableColumn(UserTable, _objectName, value))
                        _objectName = value;
                }
                else
                {
        ...
        public UserTableColumn(UserTable userTable, UserTableColumnsRow userTableColumnsRow)
        {
            Init(this, userTable, userTableColumnsRow.ObjectName, userTableColumnsRow);
        }
        ...
        public UserTableColumn(string objectName)
        {
        ...
        {
            return new UserTableColumn(userTableColumn.ObjectName)
                {
        ...
        public static bool CompareObjectNames(UserTableColumn sourceUserTableColumn, UserTableColumn targetUserTableColumn,
            ...
            switch (stringComparison)
            {
                case StringComparison.CurrentCulture:
                    return StringComparer.CurrentCulture.Compare(
                        sourceUserTableColumn.ObjectName, targetUserTableColumn.ObjectName) == 0;
        ...
        private static void Init(UserTableColumn userTableColumn, UserTable userTable, string objectName, UserTableColumnsRow userTableColumnsRow)
        {
            userTableColumn.UserTable = userTable;
            userTableColumn._objectName = string.IsNullOrEmpty(objectName)
                ? "Default"
                : objectName;
            userTableColumn.Description = "User-Table Column";

            if (userTableColumnsRow == null)
            {
            ...
            userTableColumn.Collation = userTableColumnsRow.Collation;
            userTableColumn.ColumnOrdinal = userTableColumnsRow.ColumnOrdinal;
            userTableColumn.DataType = userTableColumnsRow.DataType;
            userTableColumn.HasDefault = userTableColumnsRow.HasDefault;
            userTableColumn.HasXmlCollection = userTableColumnsRow.HasXmlCollection;
            userTableColumn.IsAnsiPadded = userTableColumnsRow.IsAnsiPadded;
            userTableColumn.IsAssemblyType = userTableColumnsRow.IsAssemblyType;
            userTableColumn.IsComputed = userTableColumnsRow.IsComputed;
            userTableColumn.IsFileStream = userTableColumnsRow.IsFileStream;
            userTableColumn.IsIdentity = userTableColumnsRow.IsIdentity;
            userTableColumn.IsNullable = userTableColumnsRow.IsNullable;
            userTableColumn.IsRowGuidColumn = userTableColumnsRow.IsRowGuidColumn;
            userTableColumn.IsUserDefined = userTableColumnsRow.IsUserDefined;
            userTableColumn.IsXmlDocument = userTableColumnsRow.IsXmlDocument;
            userTableColumn.MaxLength = userTableColumnsRow.MaxLength;
            userTableColumn.Precision = userTableColumnsRow.Precision;
            userTableColumn.Scale = userTableColumnsRow.Scale;
            userTableColumn.HasForeignKey = userTableColumnsRow.HasForeignKey;

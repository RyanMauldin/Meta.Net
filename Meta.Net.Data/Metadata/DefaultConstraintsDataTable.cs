...
{
    public class DefaultConstraintsDataTable : DataTable
    {
        ...
        public DefaultConstraintsRow this[int index]
        {
            get
            {
                return ((DefaultConstraintsRow)(Rows[index]));
            }
        }
        ...
        public DefaultConstraintsDataTable()
        {
        ...
        public void AddDefaultConstraintsRow(DefaultConstraintsRow row)
        {
            Rows.Add(row);
        }

        public DefaultConstraintsRow NewDefaultConstraintsRow()
        {
            return ((DefaultConstraintsRow)(NewRow()));
        }

        public void RemoveDefaultConstraintsRow(DefaultConstraintsRow row)
        {
            Rows.Remove(row);
        }
        ...
        {
            return typeof(DefaultConstraintsRow);
        }

        protected override DataRow NewRowFromBuilder(DataRowBuilder builder)
        {
            return new DefaultConstraintsRow(builder);
        }

...
{
    public class PrimaryKeysRow: DataRow
    {
        ...
        public PrimaryKeysDataTable DataTable { get; set; }
        ...
        public PrimaryKeysRow(DataRowBuilder rb)
            : base(rb)
        {
            DataTable = ((PrimaryKeysDataTable)(Table));
        }

...
{
    public class PrimaryKeysDataTable: DataTable
    {
        ...
        public PrimaryKeysRow this[int index]
        {
            get
            {
                return ((PrimaryKeysRow)(Rows[index]));
            }
        }
        ...
        public void AddPrimaryKeysRow(PrimaryKeysRow row)
        {
            Rows.Add(row);
        }

        public PrimaryKeysRow NewPrimaryKeysRow()
        {
            return ((PrimaryKeysRow)(NewRow()));
        }

        public void RemovePrimaryKeysRow(PrimaryKeysRow row)
        {
            Rows.Remove(row);
        }
        ...
        {
            return typeof(PrimaryKeysRow);
        }

        protected override DataRow NewRowFromBuilder(DataRowBuilder builder)
        {
            return new PrimaryKeysRow(builder);
        }

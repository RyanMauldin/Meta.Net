...
{
    public class UniqueConstraintsDataTable: DataTable
    {
        ...
        public UniqueConstraintsRow this[int index]
        {
            get
            {
                return ((UniqueConstraintsRow)(Rows[index]));
            }
        }
        ...
        public UniqueConstraintsDataTable()
        {
        ...
        public void AddUniqueConstraintsRow(UniqueConstraintsRow row)
        {
            Rows.Add(row);
        }

        public UniqueConstraintsRow NewUniqueConstraintsRow()
        {
            return ((UniqueConstraintsRow)(NewRow()));
        }

        public void RemoveUniqueConstraintsRow(UniqueConstraintsRow row)
        {
            Rows.Remove(row);
        }
        ...
        {
            return typeof(UniqueConstraintsRow);
        }

        protected override DataRow NewRowFromBuilder(DataRowBuilder builder)
        {
            return new UniqueConstraintsRow(builder);
        }
